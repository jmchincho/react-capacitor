...
const InAppPurchase = () => {
    ...
    useEffect(() => {
        ...
        store.validator = 'https://genuine-tidy-pipefish.ngrok-free.appp/api/google-play/validate';
        ...
        store.when().approved((transaction) => {
            ...
            transaction.verify().then(() => {
                ...
                fetch('https://genuine-tidy-pipefish.ngrok-free.appp/api/google-play/validate', {
                    method: 'POST',
                    headers: {
